...
This is a library to read and write .ptm files containing sprites for byter-zig (personal project).

This repository will be moved under a project once things are set in place. 
